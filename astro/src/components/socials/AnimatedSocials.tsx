...
export default function AnimatedSocials() {
  return (
    <div id="socials" class="flex justify-center gap-2">
      <Motion.div
        initial={{ scale: 0 }}
        animate={{ scale: 1 }}
        transition={{ duration: 0.5, delay: 0, easing: 'ease-in' }}
      >
        <a
        ...
        >
          <svg
            class="h-8 w-8 fill-neutral-100 transition duration-300 ease-in-out hover:fill-pink-700"
            version="1.1"
            id="Capa_1"
      ...
      <Motion.div
        initial={{ scale: 0 }}
        animate={{ scale: 1 }}
        transition={{ duration: 0.5, delay: 0.15, easing: 'ease-in'}}
      >
        <a
          ...
          >
            <g transform="translate(1 1)">
              <g>
                <g>
                  <path
                    d="M365.08-1H144.92C64.707-1-1,64.707-1,144.92v220.16C-1,445.293,64.707,511,144.92,511h220.16
                  ...
                  ></path>
                  <path
                    d="M365.08,50.2H144.92c-52.053,0-94.72,42.667-94.72,94.72v220.16c0,52.053,42.667,94.72,94.72,94.72h220.16
                  ...
                  ></path>
                  <path
                    d="M255,118.467c-75.093,0-136.533,61.44-136.533,136.533S179.907,391.533,255,391.533S391.533,330.093,391.533,255
                  ...
                  ></path>
                  <path
                    d="M255,161.133c-52.053,0-93.867,41.813-93.867,93.867c0,52.053,41.813,93.867,93.867,93.867s93.867-41.813,93.867-93.867
                  ...
                  ></path>
                  <path
                    d="M391.533,92.867c-14.507,0-25.6,11.093-25.6,25.6s11.093,25.6,25.6,25.6c14.507,0,25.6-11.093,25.6-25.6
      ...
      <Motion.div
        initial={{ scale: 0 }}
        animate={{ scale: 1 }}
        transition={{ duration: 0.5, delay: 0.3, easing: 'ease-in' }}
      >
        <a
      ...
      <Motion.div
        initial={{ scale: 0 }}
        animate={{ scale: 1 }}
        transition={{ duration: 0.5, delay: 0.45, easing: 'ease-in' }}
      >
        <a
